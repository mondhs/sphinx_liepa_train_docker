...
with open("../target/liepa_"+repo_name+".fileids", "wb") as outfile:
    for corpus_dir in os.listdir(src_dir):
        if(os.path.isdir(os.path.join(src_dir, corpus_dir))):
           with open(src_dir + "/../target/_"+ corpus_dir+"_"+repo_name+".fileids", "rb") as infile:
                for line in infile:
                    outfile.write(line)
...
with open("../target/liepa_"+repo_name+"_sil.transcription", "wb") as outfile:
    for corpus_dir in os.listdir(src_dir):
        if(os.path.isdir(os.path.join(src_dir, corpus_dir))):
           with open(src_dir + "/../target/_"+ corpus_dir+"_"+repo_name+".transcription", "rb") as infile:
                for line in infile:
